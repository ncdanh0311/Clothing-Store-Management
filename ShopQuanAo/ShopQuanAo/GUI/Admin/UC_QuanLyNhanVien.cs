    ...
    public partial class UC_QuanLyNhanVien : UserControl
    {
        ...
        private void LoadNhanVienData()
        {
            try
            {
                ...
                dgvNhanVien.Columns["VitriLamViec"].HeaderText = "Vị trí làm việc";
            }
            catch (Exception ex)
            {
        ...
        private void dgvNhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                txtVitriLamViec.Text = row.Cells["VitriLamViec"].Value.ToString();
            }
        }
        ...
        private void btnThem_NV_Click(object sender, EventArgs e)
        {
            ...
            foreach (Control ctr in tlpNhanVienInfo.Controls)
            {
                if(ctr.GetType() == typeof(TextBox))
                    ctr.ResetText();
            }
            cboGioiTinh_NV.SelectedIndex = -1;
            cboTrangThai.SelectedIndex = 0;
            dtpNgaySinh_NV.Text = DateTime.Now.Date.ToString();
        ...
        private void btnSua_NV_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string vitriLamViec = txtVitriLamViec.Text;
                ...
                bool result = nvBLL.Update(nhanVien);
                if (result)
                {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool result = nvBLL.Insert(hoTen, gioiTinh, ngaySinh, sdt, diaChi, ngayVaoLam, trangThai, luong, vitriLamViec);
                if (result)
                {
